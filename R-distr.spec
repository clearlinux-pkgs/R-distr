...
Version  : 2.9.1
Release  : 36
URL      : https://cran.r-project.org/src/contrib/distr_2.9.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/distr_2.9.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668623769
