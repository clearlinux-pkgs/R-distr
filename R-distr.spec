...
Version  : 2.7.0
Release  : 2
URL      : https://cran.r-project.org/src/contrib/distr_2.7.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/distr_2.7.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1550861611
